...
const icons: Record<string, (size: number) => React.ReactNode> = {
  ...
  youtube: (s) => (
    <svg width={s * 1.1} height={s} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
  ...
  return (
    <div className={className}>
      {socialLinks.map((link: SocialLink) => {
        const renderIcon = icons[link.platform]
